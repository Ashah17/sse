...
//added this to read each syndrome individually

template <class CALLBACK>
uint64_t read_syndrome_trace_individually(std::string input_folder, const DetailedStimCircuit&, CALLBACK, int sIndex);
