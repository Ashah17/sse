...
std::vector<memory_result_t>     memory_experiment_sbs(Decoder*, memory_config_t); //added

template <class PROLOGUE, class EPILOGUE>
memory_result_t memory_experiment(Decoder*, memory_config_t, PROLOGUE, EPILOGUE);

template <class PROLOGUE, class EPILOGUE>
std::vector<memory_result_t> memory_experiment_sbs(Decoder*, memory_config_t, PROLOGUE, EPILOGUE); //added
